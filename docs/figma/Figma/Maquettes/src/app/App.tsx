        ...
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center gap-6">
          ...
          <div className="relative">
            ...
            >
              ...
              <span style={{ fontSize: '13px', fontWeight: 500, color: '#3B2800' }}>
                Marie Laurent
              </span>
              <ChevronDown
                size={14}
            ...
            {userMenuOpen && (
              ...
              >
                <div className="px-4 py-2 border-b" style={{ borderColor: 'rgba(59,40,0,0.08)' }}>
                  <div style={{ fontSize: '13px', fontWeight: 600, color: '#3B2800' }}>
                    Marie Laurent
                  </div>
        ...
        {filtered.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 gap-4">
            ...
            <div className="text-center">
              <p style={{ fontSize: '16px', fontWeight: 600, color: '#3B2800' }}>
